<?php
  ...
  $empresa->id = $_POST["id"];
	...
	if (alteraEmpresa($conexao, $empresa)) { 
		...
		echo "<script>location.href='dados-empresa.php?id=$empresa->id';</script>";
		die();
	}
		...
		echo "<script>location.href='dados-empresa.php?id=$empresa->id';</script>"; //<script>location.href='listar-hospedes.php?cadastrado=false';</script>
		die();
	}
